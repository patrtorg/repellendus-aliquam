...
[![npm](https://img.shields.io/npm/v/@patrtorg/repellendus-aliquam.svg)](https://www.npmjs.com/package/@patrtorg/repellendus-aliquam)
[![npm](https://img.shields.io/npm/dm/@patrtorg/repellendus-aliquam.svg?style=flat)](https://www.npmjs.com/package/@patrtorg/repellendus-aliquam)
[![Coverage Status](https://coveralls.io/repos/github/Smoren/@patrtorg/repellendus-aliquam/badge.svg?branch=master&rand=123)](https://coveralls.io/github/Smoren/@patrtorg/repellendus-aliquam?branch=master)
![Build and test](https://github.com/patrtorg/repellendus-aliquam/actions/workflows/test_master.yml/badge.svg)
[![Minified Size](https://badgen.net/bundlephobia/minzip/@patrtorg/repellendus-aliquam)](https://bundlephobia.com/result?p=@patrtorg/repellendus-aliquam)
...
```typescript
import { multi } from '@patrtorg/repellendus-aliquam';
...
```typescript
import { Stream, AsyncStream } from '@patrtorg/repellendus-aliquam';
...
```typescript
import { single } from '@patrtorg/repellendus-aliquam';
...
```bash
npm i @patrtorg/repellendus-aliquam
```
...
```typescript
import { infinite } from '@patrtorg/repellendus-aliquam';
...
```typescript
import { math } from '@patrtorg/repellendus-aliquam';
...
```typescript
import { reduce } from '@patrtorg/repellendus-aliquam';
...
```typescript
import { set } from '@patrtorg/repellendus-aliquam';
...
```typescript
import { summary } from "@patrtorg/repellendus-aliquam";
...
```typescript
import { transform } from "@patrtorg/repellendus-aliquam";
...
```typescript
import { Stream } from "@patrtorg/repellendus-aliquam";
